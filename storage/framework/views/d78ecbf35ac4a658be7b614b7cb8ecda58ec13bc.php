...
<nav class="navbar">
  <div class="container" id="navbar">
    ...
    <a class="navbar-brand" href="<?php echo e(route('project.view')); ?>">PARKING</a>
    </div>
...
<!-- First Container -->
<div class="sidenav">
  <a href="<?php echo e(route('project.view')); ?>">ATADA LOT1</a>
  <a href="<?php echo e(route('project.view2')); ?>">ATADA LOT2</a>
</div>
<?php $__currentLoopData = $park; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="container-fluid bg-1 text-center "id="vd">
  ...
  <video width="700" height="400" autoplay="autoplay">
    ...
    <h3>จำนวนที่จอดรถทั้งหมด 8 || จำวนวนที่ว่าง <?php echo e($p->detect); ?></h3>
    <div>
...
<?php /**PATH E:\xampp\projectsenior\resources\views/view2.blade.php ENDPATH**/ ?>